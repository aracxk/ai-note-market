...
- **アーキテクチャ理論 (docs/01-architecture/)**
  ...
  - [Feature-based Clean Architecture設計思想 (03-clean-architecture-and-features.md)](docs/01-architecture/03-clean-architecture-and-features.md)
...
- **ドメインモデル (docs/02-domain-models/)**
  - [ドメインモデル全体マップ (overview.md)](docs/02-domain-models/overview.md)
  - [ユビキタス言語定義書 (ubiquitous-language.md)](docs/02-domain-models/ubiquitous-language.md)
...
- **設計決定記録 (docs/03-adr/)**
  - [ADR一覧・運用ルール (README.md)](docs/03-adr/README.md)
  ...
  - [ADR 0006: Repository インターフェースの配置場所の決定（usecases/ 配下への配置）](docs/03-adr/0006-repository-interface-placement.md)
- **学習振り返りログ (docs/04-learning-logs/)**
  ...
  - [Step 02: Feature-based Clean Architecture と UseCase 設計 (step-02-clean-architecture.md)](docs/04-learning-logs/step-02-clean-architecture.md)

...
export class Note extends Entity<NoteId> {
   ...
   */
  public publish(now: Date = new Date()): Result<void, InvalidNoteStatusTransitionError> {
   ...
   */
  public archive(now: Date = new Date()): Result<void, InvalidNoteStatusTransitionError> {
